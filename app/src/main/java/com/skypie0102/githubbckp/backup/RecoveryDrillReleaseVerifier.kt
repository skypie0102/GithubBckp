...
class RecoveryDrillReleaseVerifier @Inject constructor(
    ...
    private fun listRemoteReleases(repository: DrillRepositoryName, token: String): List<DrillRemoteRelease> =
        pagedJsonObjects(
            urlForPage = { page ->
