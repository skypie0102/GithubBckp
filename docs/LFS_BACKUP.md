...
Git LFS is part of the core supported personal recovery promise and remains in scope for backup verification, local restore validation, and the normal safe GitHub recovery path.
